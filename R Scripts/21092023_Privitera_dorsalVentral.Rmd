...
h.d <- sechm(se.d, degs.d, gaps_at="Region", do.scale=TRUE, show_rownames = TRUE, breaks=0.985,
      ...
      top_annotation=c("Region","Condition","Group","Sex"), row_names_gp=gpar(fontsize=8), 
...
pdf("../Figures R/Fig1h.pdf", width=8, height=7)
cowplot::plot_grid(nrow=1, labels=c("h","i"), rel_widths = c(4.1,5), scale=0.95,
...
pdf("../Figures R/revised_SF1d.pdf", width=6, height=8)
