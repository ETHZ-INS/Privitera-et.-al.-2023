...
This figure shows the stress responsive genes and their respective effect strength in PBS, Propranolol and Sotalol control vs swim comparisons
...
sig_str3_PBS_CvS <- rownames(topTags(Results[["STR3_contrasts_PBS_CtrlvsSwim"]], n = Inf, p.value = 0.05))

df_STR3_contrasts <- df_STR3_contrasts[sig_str3_PBS_CvS,]
